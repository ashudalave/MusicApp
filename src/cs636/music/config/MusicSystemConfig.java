...
public class MusicSystemConfig {
	...
	private static DataSource musicDs = null;
	...
	public static void configureCatalogService(String catalogDbName) throws Exception {
		dbDAO = new DbUtils();
	...
	public static void configureSalesService(String salesDbName) throws Exception {
		// configure service layer and DAO objects--
		// The service objects get what they need at creation-time
		// This is known as "constructor injection"
	...
	private static DataSource obtainDataSource(String dbName) throws Exception {
		if (dbName == null) {
			System.out.println("MusicSystemConfig: " + dbName + " is null (defaulting to hsqldb)");
			dbName = "hsql"; // 
		}
	...
	// Also, the Sales service layer can get the Catalog service services and vice
	// versa
